...
with open('books.csv','w', encoding= 'utf8',newline= '') as f:
    ...
    while url:
        ...
        for book in books:
            ...
            #if the scraper is unable to find the title, we want to have that information rather than it just be null
            except:
                title = 'Not Found'
            ...
            #if the scraper is unable to build the link, we want to have that information rather than it just be null
            except:
                prod_link = 'Not Found'
            ...
            #if the scraper is unable to find the price, we want to have that information rather than it just be null
            except:
                price = 'Not Found'
            ...
            #if the scraper is unable to find the availability, we want to have that information rather than it just be null
            except:
